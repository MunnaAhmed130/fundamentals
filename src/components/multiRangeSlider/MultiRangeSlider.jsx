...
const MultiRangeSlider = ({ min, max }) => {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center">
      <p>MultiRangeSlider</p>
      <div className="range-container w-full h-40 flex items-center justify-center bg-white">
        <input
          type="range"
          min={min}
          max={max}
          ...
          className="thumb thumb--left cursor-pointer absolute h-0 w-[200px] outline-none z-[3]"
        ...
        <input
          ...
          className="thumb thumb--right cursor-pointer absolute h-0 w-[200px] outline-none z-[4]"
        />
